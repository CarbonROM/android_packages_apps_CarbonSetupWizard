...
import static org.carbonrom.setupwizard.SetupWizardApp.ACTION_SETUP_FINGERPRINT;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_ALLOW_SKIP;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_AUTO_FINISH;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_DETAILS;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_FIRST_RUN;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_MATERIAL_LIGHT;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_THEME;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_TITLE;
import static org.carbonrom.setupwizard.SetupWizardApp.EXTRA_USE_IMMERSIVE;
import static org.carbonrom.setupwizard.SetupWizardApp.REQUEST_CODE_SETUP_FINGERPRINT;
