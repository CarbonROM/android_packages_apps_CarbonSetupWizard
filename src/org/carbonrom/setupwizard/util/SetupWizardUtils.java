...
package org.carbonrom.setupwizard.util;
...
import static org.carbonrom.setupwizard.SetupWizardApp.KEY_DETECT_CAPTIVE_PORTAL;
...
import org.carbonrom.setupwizard.FingerprintActivity;
...
public class SetupWizardUtils {
    ...
    String gmsSuwPackage = hasLeanback(context) ? GMS_TV_SUW_PACKAGE : GMS_SUW_PACKAGE;
        ...
        if (CrUtils.isAppInstalled(context, GMS_PACKAGE) &&
                CrUtils.isAppInstalled(context, gmsSuwPackage)) {
            PackageManager packageManager = context.getPackageManager();
            if (LOGV) {
