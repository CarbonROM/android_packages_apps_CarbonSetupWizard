...
import static org.carbonrom.setupwizard.SetupWizardApp.ACTION_LOAD;
...
public class SetupWizardActivity extends BaseSetupWizardActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (SetupWizardUtils.hasGMS(this)) {
            ...
            if (isPrimaryUser()) {
                intent.putExtra(EXTRA_SCRIPT_URI, getString(R.string.carbon_wizard_script_uri));
            } else if (getSystemService(UserManager.class).isManagedProfile()) {
                intent.putExtra(EXTRA_SCRIPT_URI, getString(
                        R.string.carbon_wizard_script_managed_profile_uri));
            } else {
                intent.putExtra(EXTRA_SCRIPT_URI, getString(R.string.carbon_wizard_script_user_uri));
            }
